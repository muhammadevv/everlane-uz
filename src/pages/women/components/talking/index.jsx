      ...
      >
        ...
        <SwiperSlide className='talking-item'>
          ...
          <div className="talking-image">
            <img className='talking-item__img' src="/women/clean/talking-1.avif" alt="" />
          </div>
        </SwiperSlide>
        <SwiperSlide className='talking-item'>
          <div className="talking-content">
          ...
          <div className="talking-image">
            <img className='talking-item__img' src="/women/clean/talking-2.avif" alt="" />
          </div>
        </SwiperSlide>
        <SwiperSlide className='talking-item'>
          <div className="talking-content">
          ...
          <div className="talking-image">
            <img className='talking-item__img' src="/women/clean/talking-3.avif" alt="" />
          </div>
        </SwiperSlide>
        <SwiperSlide className='talking-item'>
          <div className="talking-content">
          ...
          <div className="talking-image">
            <img className='talking-item__img' src="/women/clean/talking-4.avif" alt="" />
          </div>
        </SwiperSlide>
        <SwiperSlide className='talking-item'>
          <div className="talking-content">
          ...
          <div className="talking-image">
            <img className='talking-item__img' src="/women/clean/talking-5.avif" alt="" />
          </div>
        </SwiperSlide>
      </Swiper>
    </section>
